...
export function UseLayout() {
  ...
  return (
    <div className="flex h-screen gap-3 bg-gray-200 p-3">
      ...
      <div className="flex flex-1 flex-col gap-3">
        <div className="rounded-lg bg-white p-4">
          ...
          <div className="flex justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="rounded-full border p-2" onClick={toggleMode}>
                <MoonIcon />
              </div>
            </div>
          </div>
        ...
        <main className="flex-1 rounded-lg bg-white p-6">
          <Outlet />
        </main>
      </div>
    </div>
