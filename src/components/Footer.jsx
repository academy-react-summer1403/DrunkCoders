...
import {Telegram, Instagram, eNamad, Logo} from '../assets/index'
    ...
    return (
        <div className="explain sm:w-[315px] w-[296] sm:ml-10">
            ...
            <p className="text-gray-500 text-justify ">
                +13 سال سابقه فعالیت در زمینه آموزش کدنویسی از سنین کودکی تا بزرگسال. هدف ما همیشه
                این بوده که دانشجویان را با مهارت‌های لازم برای موفقیت در دنیای فناوری و برنامه
                نویسی مجهز کنیم.
            </p>
        </div>
    )
