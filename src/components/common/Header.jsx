...
import { HeaderProgressBar } from '@components/index'
  ...
  return (
    <>
      <div className="fixed left-0 z-50 w-full">
        <div className="flex w-full items-center justify-between gap-16 bg-white/60 px-5 py-6 backdrop-blur-md dark:bg-black/60 max-lg:gap-0 lg:px-8">
